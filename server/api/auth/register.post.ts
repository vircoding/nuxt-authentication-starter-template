...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    try {
      ...
      console.log('An error has ocurred while sending the confirmation email', error);
    }
    ...
    try {
      ...
      console.log('An erros has ocurred while deleting the unverified user', error);
    }
    ...
    if (userId) {
      try {
        ...
        console.log('An error has ocuured while deleting the previously created user', error);
      }
    }
